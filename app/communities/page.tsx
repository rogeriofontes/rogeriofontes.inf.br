...
export default async function Page() {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-black-900 mb-6">Comunidades</h1>
        ...
        {docs.map(d => (
          <div key={d.slug} className="card hover:shadow-md transition">
            ...
            <Link
              ...
              className="text-xl font-semibold text-black-800 hover:underline block"
            >
              {d.data.title}
            </Link>
            ...
            {d.data.url && (
              <a
                ...
                className="mt-2 block text-xs text-black-500 underline"
              >
                {d.data.url}
              </a>
            )}
            ...
            {d.data.meetup && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-1 block text-xs text-black-500 underline"
              >
                {d.data.meetup}
              </a>
            )}
